...
//        BeanFactory  -- 빈을 생성하는데 간단한 기능만 포함하고있어요.   aop 기술은 사용할 수 없어요!!
        ...
        MyBean bean1 = context.getBean("myBean",MyBean.class );  //lookup  방식..   id를 알려줌.
        bean1.setName("kang");
...
//
        ...
        System.out.println("myBean3 생성전!!!");
        ...
        if(bean4 == bean5)
            System.out.println("bean3과 bean5은 같은 인스턴스입니다.");
        else
            System.out.println("bean3과 bean5은 다른 인스턴스입니다.");
